...
var nvyt_indexController = {
    init: function () {
        ...
        nvyt_indexController.registerEvent();
    },
    ...
    registerEvent: function () {
        ...
        //    nvyt_indexController.TdVal_LoaiThietBi_Click(id);
        //});
        //// phieu click --> load kvctpct

        // giu trang thai phieu click
        $('#NhanVienYTeTbl .cursor-pointer').off('click').on('click', function () {
    ...
    //    nvyt_indexController.Load_ThietBiPartial(id, page); // KVPTC id
};
nvyt_indexController.init();